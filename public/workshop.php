<?php require_once('../includes/initialize.php'); include_once(LIB_PATH.'/helper_functions/countries_array.php');
...
if(!$user->hasLocation($session->user_id)){
	/**
	* the following should be put into a function.
	*	it is repeated in songcircle.php as well
	*/
...
<head>
	...
	<link href="css/songcircle.css" rel="stylesheet" type="text/css">
	<link href="css/songcircle_register.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="js/jquery-1.11.3.min.js"></script>
	<style>
	/* widen the songcircle schedule on this page */
		table#songcircleTable{ width: 80%; }
	</style>
</head>
<body>
	<!-- Top navigation bar -->
  ...
  <form id="host_a_songcircle" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" class="hide">
    ...
    <p>
      Select a time and date: (all times are GMT)
    </p>
    ...
    Private<input type="radio" name="songcircle_permission" value="Private" required>
    <p>
