						...
						*/
						...
						success: function(data){
							...
							if(songcircleObj.waitlist == true){
								...
								notificationMsg+= "<p>You've been added to the Waiting List for <b>"+songcircleObj.event_name+"</b> on <b>"+songcircleObj.date_time+"</b></p>";
								...
								notificationMsg+= "<p>Please visit your email to confirm your attendance to <b>"+songcircleObj.event_name+"</b> plus learn some simple tips for getting the most out of this upcoming Songcircle event.</p>";
