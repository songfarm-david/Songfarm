...
<body>
	...
	<form id="registration_form" action="" method="post">
		...
		<!-- Terms and Services -->
		<div>
			<input type="checkbox" name="terms_and_services">Terms and Services
		</div>
...
$(document).ready(function(){
	...
	function callApi(val){
		...
		$.ajax({
			url: 'http://developer.echonest.com/api/v4/artist/search?api_key='+APIkey+'&format=jsonp&name='+val+'&bucket=familiarity',
			method: 'GET',
			dataType:'jsonp',
			// cache:true,
